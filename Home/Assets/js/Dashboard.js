        ...
        ui.timerId = window.setInterval(function() {
            ...
            if (tilesWithSlides.length > window.lastTileIndex) {
                ...
                if (slides.length > 0) {
                    ...
                    firstPage.animate({
                        marginTop: -(slideIndex * firstPage.height())
                    }, 500);
...
// It takes the currentUser (defined in the SIM.master), the UI config (as above)
